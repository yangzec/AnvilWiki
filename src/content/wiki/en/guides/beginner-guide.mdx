...
Official store copy and launch coverage agree on this loop. Exact tutorial length, starting stats, and hub unlock order remain [待补充].
...
You control only the main hero in combat. Companions act on their own. Each companion needs a separate equipment set, so every recruit multiplies the inventory puzzle. Launch coverage reports two AI companions joining during a run; named companion kits and exact recruit rooms are [待补充].

See the [companions page](/characters/companions) for the sourced class list and the gaps.
...
At the end of each biome you choose one of two boss parts. Each part changes the final Guardian's appearance and power. After you finish all biomes (launch coverage reports three), you fight that assembled Guardian. The first biome boss's in-game name, HP, and attacks are [待补充].
