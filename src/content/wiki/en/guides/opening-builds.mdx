...
<Callout type="warn" title="No invented numbers">This page does not publish DPS, crit caps, or "take X by fight Y" targets. Those figures are [待补充] until they are logged in-game.</Callout>
...
Order and Chaos are reported to pull opposite ways. Pick one per character. Exact starting kits and skill trees are [待补充].
...
| Invented stat caps | Leave targets as [待补充] |
...
A ranked item table is [待补充] until placements are verified in-game. Treat any public S-C list as version-sensitive.
