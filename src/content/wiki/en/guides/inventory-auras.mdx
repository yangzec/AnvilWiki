...
| Rule | What it means | Still unknown |
| --- | --- | --- |
| No fixed slots | Any piece can sit anywhere it fits | Grid width and height are [待补充] |
| Rotation | Turn the footprint before you reject it | Per-item rotate rules are [待补充] |
| Adjacency | Commonly up, down, left, right | Some designs may differ — tooltip wins |
| Conditions | Some auras fire only for a weapon or armor class | Full condition list is [待补充] |
| One-cell moves | Shifting a piece can enable or kill a synergy | Exact bonus sizes are [待补充] |
