...
export const NAVIGATION_CONFIG: NavigationItem[] = [
  ...
  { key: 'bosses', path: '/bosses', icon: 'lucide:swords', isContentType: true, order: 2 },
  { key: 'items', path: '/items', icon: 'lucide:package', isContentType: true, order: 3 },
  { key: 'tier-list', path: '/tier-list', icon: 'lucide:bar-chart-3', isContentType: true, order: 4 },
  { key: 'characters', path: '/characters', icon: 'lucide:users', isContentType: true, order: 5 },
];
